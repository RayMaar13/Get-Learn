    ...
    <div className={"relative"}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path
          fill="#1d4ed8"
          fillOpacity="1"
          d="M0,224L80,234.7C160,245,320,267,480,245.3C640,224,800,160,960,138.7C1120,117,1280,139,1360,149.3L1440,160L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"
        ></path>
      </svg>
      <div
        className={
          "absolute right-0 top-0 flex flex-row-reverse items-center gap-4 font-inter sm:left-8 sm:top-14 sm:flex-row md:top-12"
        }
      >
        <svg
          version="1.0"
        ...
        >
          ...
          >
            <path
              d="M3835 9974 c-1430 -784 -2654 -1452 -2720 -1484 -137 -66 -194 -104
            ...
            />
            <path
              d="M12045 8293 c-16 -8 -1150 -646 -2519 -1416 l-2489 -1400 -96 20
            ...
            />
            <path
              d="M4610 5929 c0 -749 3 -939 13 -933 6 5 102 64 211 132 l199 124 46
              -52 c178 -199 407 -449 414 -449 4 -1 7 444 7 987 l0 989 -432 72 c-238 39
              -439 71 -445 71 -10 0 -13 -195 -13 -941z"
            />
          </g>
        </svg>
        <h1 className={"text-sm text-gray-700/60"}>never too late to learn</h1>
      </div>
    </div>
  );
};
